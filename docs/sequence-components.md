...
This page is generated by `docs/scripts/build-sequence-coverage.mjs` from the same examples owned by `src/diagrams/sequence/docs/coverage_examples.mjs` and exercised through `src/diagrams/sequence/tests/sequence_components.test.mjs`.
